...
namespace TrashPickup.Controllers
{
    public class RoutesController : Controller
    {
        ...
        {
            var routes = db.Routes.Include(r => r.Zip);
        ...
        public ActionResult Create([Bind(Include = "Id,ZipRefId")] Route route)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ZipRefId")] Route route)
        {
            if (ModelState.IsValid)
            {
